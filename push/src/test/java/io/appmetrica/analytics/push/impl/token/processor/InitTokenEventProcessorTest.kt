...
internal class InitTokenEventProcessorTest : CommonTest() {
    ...
    private val processor = InitTokenEventProcessor()
    ...
    fun process() {
        ...
        verify(pushMessageTrackerHub).onPushTokenInited(tokenEventJson.toString(), provider)
    }
}
