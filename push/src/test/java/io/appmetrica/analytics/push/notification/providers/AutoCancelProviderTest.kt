...
class AutoCancelProviderTest : CommonTest() {
    ...
    fun getIfFalse() {
        whenever(pushMessage.notification).thenReturn(notification)
        whenever(notification.autoCancel).thenReturn(false)
