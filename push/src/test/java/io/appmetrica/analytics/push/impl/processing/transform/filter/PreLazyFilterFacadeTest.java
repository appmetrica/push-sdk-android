...
public class PreLazyFilterFacadeTest {
    ...
    private PreLazyFilterFacade preLazyFilterFacade;
    ...
    public void setUp() {
        ...
        preLazyFilterFacade = new PreLazyFilterFacade(context, appMetricaPushCore, pushFilterController);
    }
