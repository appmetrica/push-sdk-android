...
/**
 * Event representing the processing of a silent push notification.
 *
 * <p><b>Receiving events:</b>
 * <pre>{@code
 * AppMetricaPush.addPushEventListener(new PushEventListener() {
 *     {@literal @}Override
 *     public void onSilentPushProcessed(@NonNull ProcessSilentPushEvent event) {
 ...
 * }</pre>
 *
 * @see PushEvent#processSilentEvent(String)
...
public class ProcessSilentPushEvent extends PushEvent {
     ...
     */
    @NonNull
    public ProcessSilentPushEvent withTransport(@NonNull String transport) {
     ...
     */
    @NonNull
    public ProcessSilentPushEvent withPayload(@Nullable String payload) {
