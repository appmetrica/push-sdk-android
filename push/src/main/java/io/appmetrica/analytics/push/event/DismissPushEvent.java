...
/**
 * Event representing that a push notification has been dismissed/cleared.
 *
 * <p><b>Receiving events:</b>
 * <pre>{@code
 * AppMetricaPush.addPushEventListener(new PushEventListener() {
 *     {@literal @}Override
 *     public void onNotificationDismissed(@NonNull DismissPushEvent event) {
 ...
 * }</pre>
 *
 * @see PushEvent#dismissEvent(String)
...
public class DismissPushEvent extends PushEvent {
     ...
     */
    @NonNull
    public DismissPushEvent withTransport(@NonNull String transport) {
     ...
     */
    @NonNull
    public DismissPushEvent withPayload(@Nullable String payload) {
