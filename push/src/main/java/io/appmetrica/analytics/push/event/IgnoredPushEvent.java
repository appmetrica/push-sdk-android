...
/**
 * Event representing that a push notification has been ignored.
 *
 * <p><b>Receiving events:</b>
 * <pre>{@code
 * AppMetricaPush.addPushEventListener(new PushEventListener() {
 *     {@literal @}Override
 *     public void onNotificationIgnored(@NonNull IgnoredPushEvent event) {
 ...
 * <pre>{@code
 * // Create event
 * IgnoredPushEvent event = PushEvent.ignoredEvent(pushId, category, details)
 ...
 * }</pre>
 *
 * @see PushEvent#ignoredEvent(String, String, String)
...
public class IgnoredPushEvent extends PushEvent {
     ...
     */
    @NonNull
    public IgnoredPushEvent withTransport(@NonNull String transport) {
     ...
     */
    @NonNull
    public IgnoredPushEvent withPayload(@Nullable String payload) {
     ...
     *
     * @param category reason why push notification is ignored
     * @return current builder instance for chaining
     */
    @NonNull
    public IgnoredPushEvent withCategory(@Nullable String category) {
     ...
     *
     * @param details details on which push notification is ignored
     * @return current builder instance for chaining
     */
    @NonNull
    public IgnoredPushEvent withDetails(@Nullable String details) {
