...
public class DefaultIdentifierFromMetaDataExtractorTests extends ExtractorTests {
    ...
    String createApiKey() {
        ...
        mInfo.metaData.putString(META_DATA_DEFAULT_API_KEY, apiKey);
    ...
    String createAppId() {
        ...
        mInfo.metaData.putString(META_DATA_DEFAULT_APP_ID, appId);
    ...
    String createSenderId() {
        ...
        mInfo.metaData.putString(META_DATA_DEFAULT_SENDER_ID, "number:" + senderId);
    ...
    String createProjectId() {
        ...
        mInfo.metaData.putString(META_DATA_DEFAULT_PROJECT_ID, projectId);
